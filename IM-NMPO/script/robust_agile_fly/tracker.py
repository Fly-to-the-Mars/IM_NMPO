...
from quadrotor import QuadrotorModel_nominal, rotate_quat,QuadrotorModel
...
class TrackerPos_1():
    def __init__(self, quad:QuadrotorModel_nominal):
        self._quad = quad
        self._Herizon = 5
        self._ddynamics = []
    ...
    def solve(self, xinit, Trj, dt, time_factor=0.85):
...
if __name__ == "__main__":
    ...
    quad = QuadrotorModel_nominal(BASEPATH+"quad/quad_real.yaml")
    tracker = TrackerPos_1(quad)
    tracker.define_opt()
    tracker._opt_solver.generate_dependencies("tracker_pos_1.c")    
    system('gcc -fPIC -shared -O3 ' + "tracker_pos_1.c" + ' -o ' + './tracker_pos_1.so')